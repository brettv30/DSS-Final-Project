...
(
	...
	PROD_SKU_NO          NUMERIC(5) NOT NULL,
	PROD_LN_CD           VARCHAR(2) NULL,
	POD_CAT_CD           VARCHAR(1) NOT NULL,
	PROD_PACK_SZ_NO      NUMERIC(5) NULL,
	PROD_INTRO_DT        DATE NOT NULL
);

ALTER TABLE PRODUCTS
ADD CONSTRAINT IDX_PROD_PROD_PK PRIMARY KEY (PROD_ID);
...
(
	...
	SLS_UNT_CST_AM       NUMERIC(15,2) NOT NULL,
...
(
	...
	STR_STREET_AD        VARCHAR(20) NOT NULL,
...
ALTER TABLE STORE
ADD CONSTRAINT IDX_STR_STR_PK PRIMARY KEY (STR_ID);
...
ALTER TABLE SALES_FACTS
ADD CONSTRAINT STORE_SALES_FACTS FOREIGN KEY (STR_ID) REFERENCES STORE (STR_ID);
